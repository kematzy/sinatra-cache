...
Adds simple Page Caching to "Sinatra":http://www.sinatrarb.com/
...
*NB!* Very unfinished work, so use with care.
 ...
 # Make it work with Sub-classed Sinatra Apps => [MyApp < Sinatra::Base or Default] (problems with configs)
 # Add logging output
