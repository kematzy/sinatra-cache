...
<b>NB! There is currently a problem with adding the <tt>sinatra-cache</tt> gem on RubyGems.org</b>

While we try to sort out the issue, please clone the source and do a manual install.
...
---
  ...
  $  (sudo)? gem install sinatra-cache --version 0.3.0
